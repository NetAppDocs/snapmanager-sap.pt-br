...
[role="lead"]
Você pode executar o `profile verify` comando para verificar a configuração do perfil. Você deve montar o banco de dados antes de executar este comando.
